export default function CartButton() {
    return <button className="hidden product-cart lg:flex flex-col items-center justify-center p-3 pt-3.5 fixed top-1/2 -mt-12 end-0 z-40 shadow-900 rounded rounded-te-none rounded-be-none bg-accent text-light text-sm font-semibold transition-colors duration-200 focus:outline-none hover:bg-accent-hover">
        <span className="flex pb-0.5">
            <svg width="14" height="16" className="flex-shrink-0" viewBox="0 0 12.686 16">
        ...
        <span className="bg-light rounded w-full py-2 px-2 text-accent mt-3">$0.00</span>
    </button>
}